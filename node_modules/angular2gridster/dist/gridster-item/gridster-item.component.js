    ...
    GridsterItemComponent.prototype.enableDragDrop = function () {
        ...
        this.zone.runOutsideAngular(function () {
            ...
            var dragSub = draggable.dragMove
                .subscribe(function (event) {
                var scrollData = _this.gridster.gridsterScrollData;
                _this.$element.style.top = (event.clientY - cursorToElementPosition.y - scrollData.scrollTop -
                    _this.gridster.gridsterRect.top) + 'px';
                _this.$element.style.left = (event.clientX - cursorToElementPosition.x - scrollData.scrollLeft -
                    _this.gridster.gridsterRect.left) + 'px';
